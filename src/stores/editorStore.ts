  ...
  persist(
    (set, get) => ({
      ...
      updateBrandingColors: (colors) => {
        ...
        set({ brandingKit: { ...current, colors } });
      },
      
      addBrandingLogo: (logo) => {
        const current = get().brandingKit;
        set({ brandingKit: { ...current, logos: [...current.logos, logo] } });
      },
      
      deleteBrandingLogo: (index) => {
        const current = get().brandingKit;
        set({ brandingKit: { ...current, logos: current.logos.filter((_, i) => i !== index) } });
      },
    ...
    }),
    {
      ...
      partialize: (state) => ({
        ...
        brandingKit: state.brandingKit,
        videoClips: state.videoClips,
        audioTracks: state.audioTracks,
        savedVideoTemplates: state.savedVideoTemplates,
        apiKey: state.apiKey,
